package com.example.application.views.objectadmin;
...
@Route(value = "object-admin/:sampleBookID?/:action?(edit)", layout = MainView.class)
@PageTitle("Object Admin")
@CssImport("./views/objectadmin/object-admin-view.css")
public class ObjectAdminView extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "object-admin/%d/edit";
    ...
    public ObjectAdminView(@Autowired SampleBookService sampleBookService) {
        this.sampleBookService = sampleBookService;
        addClassName("object-admin-view");
        // Create UI
        ...
        grid.setDataProvider(new CrudServiceDataProvider<>(sampleBookService));
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(ObjectAdminView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleBookId.isPresent()) {
            ...
            if (sampleBookFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(ObjectAdminView.class);
            }
        }
    }
